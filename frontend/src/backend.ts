...
export class Backend implements backendInterface {
    ...
    async addShoe(arg0: string, arg1: string, arg2: string, arg3: string, arg4: bigint, arg5: Array<bigint>, arg6: Array<string>, arg7: Array<string>): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.addShoe(arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7);
                return result;
            } catch (e) {
                this.processError(e);
    ...
    async filterByCategory(arg0: string): Promise<Array<Shoe>> {
        if (this.processError) {
            try {
    ...
    async getAllShoes(): Promise<Array<Shoe>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllShoes();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getShoe(arg0: string): Promise<Shoe> {
        if (this.processError) {
            try {
                const result = await this.actor.getShoe(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
